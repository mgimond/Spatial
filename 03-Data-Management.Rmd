...
```{r f02-gdb, echo=FALSE, fig.cap = "Sample content of an ArcGIS file geodatabase. (src: esri)", out.width=444}
...
```{r f02-catalog, echo=FALSE, fig.cap = "Windows Explorer view vs. ArcCatalog view. Note, for example, how the many files that make up the Cities shapefile (as viewed in a Windows file manager environment) appears as a single entry in the ArcCatalog view. This makes it easier to rename the shapefile since it needs to be done only for a single entry in ArcCatalog (as opposed to renaming the Cities files seven times in the Windows file manager environment).", out.width=1071}
